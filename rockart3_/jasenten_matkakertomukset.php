...
?>
            <div class="divMenu">
                <ul class="ulMenu2">
                    ...
                    <li class="liMenu2"><b><?php while ($tulosjoukko17 = mysql_fetch_array($kysely17)) { if ($tulosjoukko17["id"] == 17) { print (($tulosjoukko17["sivu_nimi"])); } } ?></b></li>
                </ul>
...
<div class="divSisalto">
    ...
    <div class="divMainSisalto">
            <h3>J&auml;senten matkakertomukset</h3>
            <?php
	//haetaan etusivulle haluttu teksti
	$sql_lause = "SELECT * FROM kuvat WHERE sivu_id=3";
