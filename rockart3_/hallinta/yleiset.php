...
$insstmt = "INSERT INTO yleiset (otsikko,sisalto,pdf_otsikko,sivu_id,pdf)"
		   ."VALUES"." ('".$otsikko."', '".$sisalto."', '".$pdf_otsikko."', '".$sivu_id."', '".$pdf."')";
...
$pdf=$_REQUEST["pdf"];
    ...
    if (file_exists("../yleiset_mat/" . $_FILES["pdf"]["name"])) {
      }//if
    else {
      move_uploaded_file($_FILES["pdf"]["tmp_name"],
      "../yleiset_mat/".$_FILES["pdf"]["name"]);
      }//else
    }//else
} //if
$pdf=$_FILES["pdf"]["name"];
...
if ($pdf !=null){
    ...
    $id=$_REQUEST["id"];
    $delstmt = "DELETE FROM yleiset WHERE id = ".$id;
...
<?php if ($do == "del") {
	...
	<?php while ($yleiset = mysql_fetch_array($result)) {
            print "<form method='POST' class='poistaForm' action='yleiset.php' >";
            print "<input type='hidden' name='pdf' value='".$yleiset["pdf"]."'>";
	...
	<?php
        ...
        ?>
        <br/><p class="pSisalto"><a href="yleiset.php">Takaisin</a></p>
	<br/><br/>
<?php } //if
    ...
    print "<input type='hidden' name='id' value='".$id."'>";
        print "<table class='table01' border='0' cellpadding='10' cellspacing='4' width='70%'>";
            print "<tr>";
                ...
                print "<input type='text' name='otsikko' value='".$yleiset["otsikko"]."' size='40'></td>";
            print "</tr>";
            print "<tr>";
           ...
           print "<tr>";
                ...
                print " <select name='sivu_id'>";
                    if ($yleiset["sivu_id"] == 1){ print " <option value='1'>Etusivu</option>"; }
                    if ($yleiset["sivu_id"] == 2){ print " <option value='2'>Seura/S&auml;&auml;nn&ouml;t</option>"; }
                    if ($yleiset["sivu_id"] == 3){ print " <option value='3'>Ajankohtaista</option>"; }
                    if ($yleiset["sivu_id"] == 4){ print " <option value='4'>Tutkimus/Tutkimusraportit</option>"; }
                    if ($yleiset["sivu_id"] == 5){ print " <option value='5'>Seminaariluennot</option>"; }
                    if ($yleiset["sivu_id"] == 6){ print " <option value='6'>Yhteystiedot</option>"; }

                    print " <option value='1'>Etusivu</option>";
        ...
        print "<table class='table01' border='0' cellpadding='10' cellspacing='4' width='70%'>";
            print "<tr>";
                print "<td class='table01_row01'><b>Pdf otsikko:</b><br/>";
                print "<input type='text' name='pdf_otsikko' value='".$yleiset["pdf_otsikko"]."' size='40'></td>";
            print "</tr>";
             print "<tr>";
                print "<td>";
                print "T&auml;m&auml;n hetkinen pdf:<br/>";
                print ($yleiset["pdf"]."<br/>");
                print "</td>";
                print "<td>";
                print "<a href='".$PHP_SELF."?id=".$yleiset["id"]."&do=addp'>Vaihda pdf</a>";
                print "</td>";
            print "</tr>";
        print "</table>";
}
...
?>
	...
	<?php } else {?>
        <p class="pSisalto">
	<a href="yleiset2.php">Lis&auml;&auml; uusi sis&auml;lt&ouml;</a><br/><br/>
	...
	<table class="table01" border="0" cellpadding="4" cellspacing="0" width="80%">
		...
		<td class="table01_otsikko" align="left" width="45%"><b>Otsikko</b></td>
                <td class="table01_otsikko" align="left" width="25%">Sivulla</td>
		<td class="table01_otsikko" align="center" width="16%">Poista sivu</td>
		</tr>
	...
	<?php while ($yleiset = mysql_fetch_array($result)) {
		...
		print "<td class='table01_row".$rivityyli."' align='left'>".$yleiset["otsikko"]."</td>";
                    if ($yleiset["sivu_id"] == 1){ print "<td class='table01_row".$rivityyli."' align='left'>Etusivu</td>"; }
                    if ($yleiset["sivu_id"] == 2){ print "<td class='table01_row".$rivityyli."' align='left'>Seura/S&auml;&auml;nn&ouml;t</td>"; }
                    if ($yleiset["sivu_id"] == 3){ print "<td class='table01_row".$rivityyli."' align='left'>Ajankohtaista</td>"; }
                    if ($yleiset["sivu_id"] == 4){ print "<td class='table01_row".$rivityyli."' align='left'>Tutkimus/Tutkimusraportit</td>"; }
                    if ($yleiset["sivu_id"] == 5){ print "<td class='table01_row".$rivityyli."' align='left'>Seminaariluennot</td>"; }
                    if ($yleiset["sivu_id"] == 6){ print "<td class='table01_row".$rivityyli."' align='left'>Yhteystiedot</td>"; }
                print "<td class='table01_row".$rivityyli."' align='center'><a href='".$PHP_SELF."?id=".$yleiset["id"]."&do=del'><img src='images/icon_delete.GIF' border='0' alt='Poista sivu'></a></td>";
                print "</tr>";
